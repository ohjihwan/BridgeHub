...
('admin@test.com', '01012345678', '관리자', '이관리', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS',, '대학교', '컴퓨터공학과', '남자', '서울특별시', '송파구', '오전', '/images/profile.jpg', 'ACTIVE', TRUE, '관리자입니다.', NOW() - INTERVAL 30 DAY)
('user1@test.com', '01066596264', '열정소녀', '김사과', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '경영학과', '여자', '서울특별시', '강서구', '야간', '/images/profile/1.jpg', 'ACTIVE', TRUE, '기업 경영에 대한 이해를 바탕으로 창업을 목표로 하고 있어요.',NOW() - INTERVAL 26 DAY),
('user2@test.com', '01020648974', '프론트여신', '반하나', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '컴퓨터공학과', '여자', '부산광역시', '남구', '오후', '/images/profile/2.jpg', 'ACTIVE', TRUE, '풀스택 개발자가 되기 위해 프론트와 백엔드 모두 학습 중입니다.',NOW() - INTERVAL 29 DAY),
('user3@test.com', '01041639056', '교수꿈나무', '이메론', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '교육학과', '여자', '경상북도', '포항시 남구', '오후', '/images/profile/3.jpg', 'ACTIVE', TRUE, '현장 중심의 교육방법론을 연구 중이며, 협업 학습에 관심이 많아요.',NOW() - INTERVAL 28 DAY),
('user4@test.com', '01037153181', '문학소녀', '박망고', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '국어국문학과', '여자', '경기도', '고양시 일산서구', '오전', '/images/profile/4.jpg', 'ACTIVE', TRUE, '고전 문학과 현대 문학을 분석하며 작문 실력을 키우고 있습니다.',NOW() - INTERVAL 10 DAY),
('user5@test.com', '01013176974', '금융전문가', '지수빈', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '경제학과', '남자', '서울특별시', '노원구', '오후', '/images/profile/5.jpg', 'ACTIVE', TRUE, '금융시장 분석과 통계모델링에 집중하고 있어요.',NOW() - INTERVAL 20 DAY),
('user6@test.com', '01077526120', '행정도전', '안유진', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '행정학과', '여자', '서울특별시', '강동구', '오후', '/images/profile/6.jpg', 'ACTIVE', TRUE, '공공정책 기획과 정책 평가에 흥미가 있습니다.',NOW() - INTERVAL 15 DAY),
('user7@test.com', '01006005753', '코딩남', '박취업', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '컴퓨터공학과', '남자', '대구광역시', '달서구', '오후', '/images/profile/7.jpg', 'ACTIVE', TRUE, 'AI와 시스템 아키텍처에 집중하며 프로젝트 경험을 쌓고 있어요.',NOW() - INTERVAL 18 DAY),
('user8@test.com', '01060811242', '법조인꿈나무', '권지용', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '법학과', '남자', '광주광역시', '북구', '오전', '/images/profile/8.jpg', 'ACTIVE', TRUE, '사회 정의를 실현하는 법조인을 목표로 공부하고 있어요.',NOW() - INTERVAL 11 DAY),
('user9@test.com', '01049281856', '물리소녀', '오렌지', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '융합물리학과', '여자', '충청북도', '청주시 상당구', '오전', '/images/profile/9.jpg', 'ACTIVE', TRUE, '양자역학과 나노소자에 관심이 많습니다.',NOW() - INTERVAL 9 DAY),
('user10@test.com', '01057825910', '문학연구생', '최에리', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '영어영문학과', '여자', '대구광역시', '중구', '오후', '/images/profile/10.jpg', 'ACTIVE', TRUE, '영문학과 문화 연구를 통해 글로벌 인사이트를 넓히고 있어요.',NOW() - INTERVAL 23 DAY),
('user11@test.com', '01010280712', '중문전문가', '한지민', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '중어중문학과', '여자', '부산광역시', '해운대구', '야간', '/images/profile/11.jpg', 'ACTIVE', TRUE, '중국 문화와 언어에 관심이 많아 전문 통번역을 준비 중입니다.',NOW() - INTERVAL 12 DAY),
('user12@test.com', '01003594987', '호텔리어', '최유리', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '호텔경영학과', '여자', '경기도', '고양시 덕양구', '오후', '/images/profile/12.jpg', 'ACTIVE', TRUE, '서비스 품질 개선과 리더십 개발에 관심이 있어요.',NOW() - INTERVAL 19 DAY),
('user13@test.com', '01029865110', '경제연구생', '이석민', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '경제학과', '남자', '충청북도', '청주시 상당구', '야간', '/images/profile/13.jpg', 'ACTIVE', TRUE, '거시경제 이론과 정책 분석에 관심이 많습니다.',NOW() - INTERVAL 7 DAY),
('user14@test.com', '01076883860', '문학청년', '홍지수', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학교', '국어국문학과', '남자', '대구광역시', '달서구', '오전', '/images/profile/14.jpg', 'ACTIVE', TRUE, '한국 현대시 분석과 창작 활동을 꾸준히 하고 있어요.',NOW() - INTERVAL 4 DAY),
('user15@test.com', '01027900010', '법학소녀', '배수지', '$2b$12$LVEp.rWiI6grR2aDPyNIe.A4WB1lJ8vbH.nuDwSPLegcoCQL4SfSS', '대학원', '법학과', '여자', '부산광역시', '수영구', '오후', '/images/profile/15.jpg', 'ACTIVE', TRUE, '헌법과 형법 분야의 전문성을 쌓고 싶습니다.',NOW() - INTERVAL 15DAY);
